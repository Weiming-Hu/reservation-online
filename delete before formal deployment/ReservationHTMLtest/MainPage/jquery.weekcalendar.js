...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _checkButtonAvailable : function() {
         if (this.relative_week_id == 0) {
             $(".wc-next").attr('disabled', false);
             $(".wc-prev").attr('disabled', true);
         }
         else if (this.relative_week_id == 1) {
             $(".wc-next").attr('disabled', true);
             $(".wc-prev").attr('disabled', false);
         }
      },
      ...
      // Weiming added
      // we don't need any mouse event for creating new events
      /*
...
//      },
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         shortDays : ['周一', '周二', '周三', '周四', '周五', '周六', '周七'],
         longDays : ['周一', '周二', '周三', '周四', '周五', '周六', '周七']
      }
   });
